    ...
    namespace nsGameEngine
    {
        namespace nsCollider
        {
            ...
            private:
                ...
                virtual bool                otherFitsInto (const Rectangle & other) const noexcept;
                virtual bool                collidesV     (const Rectangle & other) const noexcept;

                virtual bool                otherFitsInto (const Circle    & other) const noexcept;
                virtual bool                collidesV     (const Circle    & other) const noexcept;
